...
namespace MaxmindSDK
{
    ...
    {
        private static readonly Dictionary<string, Dictionary<string, string>> GeoIPRegionNames = InitRegionNames();
        ...
        public static string GetRegionName(string ccode, string region)
        {
            ...
            if (!GeoIPRegionNames.ContainsKey(ccode))
            {
                return string.Empty;
            }

            return (GeoIPRegionNames[ccode])[region];
        }

        private static Dictionary<string, Dictionary<string, string>> InitRegionNames()
        {
            var regionNames = new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase);

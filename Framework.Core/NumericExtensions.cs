...
namespace Framework
{
    ...
    public static class NumericExtensions
    {
        ...
        public static int UnsignedByteToInt(this byte b)
        {
            return b & 0xFF;
        }

        public static string PadLeft(this int value, int totalWidth, char paddingChar = '0')
        {
            return value.ToString(CultureInfo.InvariantCulture).PadLeft(totalWidth, paddingChar);
        }

        public static string PadRight(this int value, int totalWidth, char paddingChar = '0')
        {
            return value.ToString(CultureInfo.InvariantCulture).PadRight(totalWidth, paddingChar);
        }
    }
